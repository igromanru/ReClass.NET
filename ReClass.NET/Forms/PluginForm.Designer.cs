...
namespace ReClassNET.Forms
{
	partial class PluginForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Plugins can provide different methods how SuperClass accesses a remote process.\r" +
    ...
    "n.";
			...
			this.bannerBox.Text = "Here you can configure all loaded SuperClass plugins.";
